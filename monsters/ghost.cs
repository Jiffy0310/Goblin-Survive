...
public class ghost : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        if(Vector3.Distance(transform.position, goblin.I.transform.position) < 2.5f)
        {
